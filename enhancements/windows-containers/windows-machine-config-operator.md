---
title: Using Machine API in Windows Machine Config Operator
authors:
...
# Using Machine API in Windows Machine Config Operator
...
Windows Machine Config Operator(WMCO) as of now is relying on tool called 
Windows Node Installer(WNI) to provision Windows VMs in the OpenShift cluster. 
